...
export default function MyProfile() {
  ...
  const handleDelete = async () => {
    const confirmDelete = window.confirm("Are you sure you want to PERMANENTLY delete your account? This will also delete all your blogs, reviews, and votes. This action cannot be undone."
    );
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="lg:col-span-1">
            <DashboardCard className="border-none bg-gray-50 p-8 text-center  dark:bg-gray-900/50">
              ...
              <p className="mt-2 text-gray-600 dark:text-gray-400 dark:text-gray-600 dark:text-gray-400">
                {user?.email}
              </p>
              {analytics && (
          ...
          <div className="flex flex-col gap-8 lg:col-span-2">
            ...
            <DashboardCard className="border-red-100 bg-red-50/30 p-6 dark:border-red-900/30 dark:bg-red-900/10">
              ...
              <p className="mb-6 text-sm text-gray-600 dark:text-gray-600 dark:text-gray-400">
