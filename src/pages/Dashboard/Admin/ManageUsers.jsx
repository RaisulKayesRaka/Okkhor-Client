                ...
                {users.map((user) => (
                  ...
                  >
                    ...
                    <td className="whitespace-nowrap px-6 py-4">
                      {" "}
                      <span
                        className={`inline-flex rounded-full px-2.5 py-0.5 text-xs font-medium ${user?.role === "admin" ? "bg-purple-100 text-purple-700 dark:bg-purple-900/20 dark:text-purple-400" : user?.role === "moderator" ? "bg-blue-100 text-blue-700 dark:bg-blue-900/20 dark:text-blue-400" : "bg-gray-100 text-gray-700 dark:bg-gray-800 dark:text-gray-400"}`}
                      >
                        {" "}
                        {user?.role}{" "}
                      </span>{" "}
