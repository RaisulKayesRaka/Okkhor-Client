        ...
        <div className="-gray-200/50 dark: w-full max-w-[450px] rounded-2xl border border-gray-200 bg-white p-8 dark:border-gray-800 dark:bg-gray-900 sm:p-10">
          ...
          <div className="mb-4 grid grid-cols-3 gap-2">
            ...
            <button
              onClick={() => {
                if (emailRef.current)
                  emailRef.current.value = "raisulkayesofficial@gmail.com";
                const passwordInput = document.getElementById("password");
                if (passwordInput) passwordInput.value = "Password@123";
              }}
              type="button"
              className="rounded-xl border border-gray-200 bg-white py-2 text-xs font-bold text-gray-700 transition hover:bg-gray-50 focus:scale-[0.98] dark:border-gray-800 dark:bg-transparent dark:text-white dark:hover:bg-gray-800"
            >
              {" "}
              Demo User{" "}
            </button>{" "}
            <button
              onClick={() => {
                if (emailRef.current)
                  emailRef.current.value = "moderator@okkhor.com";
                const passwordInput = document.getElementById("password");
                if (passwordInput) passwordInput.value = "Password@123";
              }}
              type="button"
            ...
            <button
              onClick={() => {
                if (emailRef.current)
                  emailRef.current.value = "admin@okkhor.com";
                const passwordInput = document.getElementById("password");
                if (passwordInput) passwordInput.value = "Password@123";
              }}
              type="button"
