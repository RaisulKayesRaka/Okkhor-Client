        ...
        {!user && feedType === "following" ? (
          <div className="flex min-h-[40vh] flex-col items-center justify-center rounded-2xl border border-gray-200/50 bg-gray-50/50 p-12 text-center dark:border-gray-800 dark:bg-gray-800/20">
            ...
            <p className="mt-2 text-gray-600 dark:text-gray-400">
              You need to be logged in to view blogs from authors you follow.
            </p>
            <button
              onClick={() => navigate("/login", { state: location.pathname })}
              className="mt-6 rounded-full bg-green-600 px-8 py-3 text-sm font-bold text-white transition hover:bg-green-700 dark:bg-green-500 dark:hover:bg-green-600"
            >
              Log In
            </button>
          </div>
