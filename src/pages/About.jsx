  ...
  return (
    <section className="mx-auto my-12 w-11/12 max-w-screen-xl">
      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
        <div className="rounded-2xl border border-gray-100 bg-white p-8 shadow-sm transition hover:shadow-md dark:border-gray-800 dark:bg-gray-900">
          <h2 className="text-xl font-bold text-gray-900 dark:text-white">
            Our Mission
          </h2>
          <p className="mt-4 text-gray-600 dark:text-gray-400">
            Our mission is to empower creators by providing a platform to
            showcase their blogs, gain feedback, and reach a global audience.
          </p>
        </div>
