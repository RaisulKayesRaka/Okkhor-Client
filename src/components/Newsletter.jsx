      ...
      <div className="rounded-3xl bg-gray-50 px-6 py-12 text-center dark:bg-gray-900/50 md:px-16">
        ...
        >
          ...
          <input
            ...
            className="w-full flex-1 rounded-xl border border-gray-200 bg-white px-4 py-3 text-sm outline-none transition focus:border-black focus:ring-1 focus:ring-black dark:border-gray-800 dark:bg-black dark:text-white dark:focus:border-white dark:focus:ring-white"
          />{" "}
          <button
            type="submit"
